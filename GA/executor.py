...
class State:
    def __init__(self, points: list[Point], solutions: list[PairRectangleInt], best_solution: Rectangle):
        self._points = points
...
class Executor:
    def __init__(self,
                 next_generation: Callable[[list[Point], list[PairRectangleInt], ParamGeneticAlgorithm], list[Rectangle]],
                 points: list[Point],
                 first_generation: list[PairRectangleInt],
